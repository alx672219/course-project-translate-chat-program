...
public class SendMessageController {
     ...
     */
    private Message createMessage(int id, String message, User receiver, User recipient, Date timestamp) {
    ...
    public void sendMessage(int id, String message, User receiver, User recipient, Date timestamp) {
        Message messageToSend = createMessage(id, message, receiver, recipient, timestamp);
